...
const Map<String, Map<AppLang, String>> _kStrings = {
  ...
  'feat.2.title': {
    AppLang.en: 'Gentle Reminders',
    AppLang.fr: 'Rappels discrets',
  },
  'feat.2.text': {
  ...
  'feat.3.title': {
    AppLang.en: 'Snappy & Smooth',
    AppLang.fr: 'Rapide et fluide',
  },
  'feat.3.text': {
  ...
  // Privacy (résumé – vous pouvez étendre)
  'privacy.title': {
  ...
  // Legal (résumé – synchronisé avec votre page)
  'legal.title': {
