...
const Map<String, Map<AppLang, String>> _kStrings = {
  ...
  // ===================== Delete account =====================
  'delete.appbar': {
    AppLang.fr: '🗑️ Suppression de compte',
    AppLang.en: '🗑️ Account Deletion',
  },
  'delete.heading': {
    AppLang.fr: 'Suppression de compte — Puzzix',
    AppLang.en: 'Account Deletion — Puzzix',
  },
  'delete.intro': {
    AppLang.fr:
    'Si vous souhaitez supprimer votre compte et toutes vos données associées, veuillez envoyer une demande à l’adresse suivante :',
    AppLang.en:
    'If you wish to delete your account and all associated data, please send a request to:',
  },
  'delete.email_line': {
    AppLang.fr: '📧 support@puzzixapp.com',
    AppLang.en: '📧 support@puzzixapp.com',
  },
  'delete.deadline': {
    AppLang.fr:
    'Dans votre demande, précisez l’adresse e-mail utilisée pour créer votre compte. Une fois la demande reçue, votre compte et vos données seront définitivement supprimés de nos serveurs dans un délai de 30 jours maximum.',
    AppLang.en:
    'In your request, please specify the email address you used to create the account. Once received, your account and data will be permanently deleted from our servers within 30 days.',
  },
  'delete.warning': {
    AppLang.fr:
    '⚠️ Certaines données techniques (par ex. journaux de sécurité) peuvent être conservées temporairement pour des raisons légales ou de sécurité, mais elles ne sont plus liées à votre identité.',
    AppLang.en:
    '⚠️ Certain technical data (e.g., security logs) may be temporarily retained for legal or security reasons, but it will no longer be linked to your identity.',
  },
  'delete.proc_title': { AppLang.fr: 'Procédure', AppLang.en: 'Procedure' },
  'delete.proc_1': {
    AppLang.fr:
    'Envoyez un e-mail à support@puzzixapp.com avec pour objet : « Suppression de compte ».',
    AppLang.en:
    'Send an email to support@puzzixapp.com with the subject: “Account Deletion”.',
  },
  'delete.proc_2': {
    AppLang.fr:
    'Indiquez dans le corps du message l’adresse e-mail utilisée pour créer le compte.',
    AppLang.en:
    'Include in the email body the address you used to create the account.',
  },
  'delete.proc_3': {
    AppLang.fr:
    'Vous recevrez une confirmation par e-mail lorsque la suppression aura été effectuée.',
    AppLang.en:
    'You will receive a confirmation email once the deletion has been completed.',
  },
  'delete.notes_title': { AppLang.fr: 'Remarques', AppLang.en: 'Notes' },
  'delete.note_1': {
    AppLang.fr:
    'La suppression est irréversible : vous ne pourrez plus récupérer vos données une fois l’opération effectuée.',
    AppLang.en:
    'Deletion is irreversible: you will not be able to recover your data once completed.',
  },
  'delete.note_2': {
    AppLang.fr:
    ...
    AppLang.en:
    'In accordance with applicable laws, certain anonymised or legal data may be retained for a limited period.',
  },
};
